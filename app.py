...
# ========== Page Config ==========
st.set_page_config(page_title="GitNews Trend Chat", layout="wide")
st.title("📰 GitNews Trend Chatbot")
...
def chat_api(message: str, tags: List[str], keyword: str) -> dict:   
    ...
    prompt_template = ChatPromptTemplate.from_messages([
        ("system", """You are a helpful AI assistant specializing in summarizing and explaining the latest tech trends from sources like GitNews.
